...
export default function Payouts(props) {
    ...
    return (<View style = {{alignContent: "center", alignItems: "center", display: "flex", width: "100%", minHeight: "100%", height: "auto", backgroundColor:"#FFFFFF"}}>
        ...
        <TopBar/>
        <Image style = {{height: 0.75*windowHeight, width: windowWidth, alignSelf: "center", top: 0.02*windowHeight, marginTop: -0.015*windowHeight}} resizeMode={'cover'} source = {require('../assets/payoutsScreenshot.png')}/>

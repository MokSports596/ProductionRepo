  ...
  function handleButtonPress() {
    if (onPage == 'sign up') {
      if (name.trim() != '' && email.trim() != '' && password.trim() != '') {
        //INCUDE LOGIC FOR UNIQUENESS OF EMAIL
        setPage('league')
      } else {
    ...
    if (onPage == 'league') {
      ...
      try {
        //FIX JS FOR TESTING VALIDITY OF CODE
    ...
    >
      <View style={{ backgroundColor: '#FFFFFF' }}>
        ...
        {(onPage == 'league' || onPage == 'username') && ( //To make the left arrow in the top left corner on signing up league page
          <TouchableOpacity
            onPress={() =>
              onPage == 'username' ? unCreateLeague() : setPage('sign up')
            }
            style={{
              position: 'absolute',
              height: 0.05 * windowHeight,
          ...
          >
            <Image
              ...
              resizeMode={'cover'}
              source={require('../assets/Login/leftarrow.png')}
            />
          </TouchableOpacity>
        )}
        ...
        {onPage == 'sign up' && ( //To make the newsletter appear correctly
          ...
          >
            ...
            <Image
              ...
              resizeMode={'cover'}
              source={require('../assets/Login/unchecked.png')}
            />
          </View>
        )}
        ...
        {onPage == 'league' && ( //To make the "Dont have an account" only show up on login
          ...
          >
            <Text style={{ fontSize: 20 }}>League Manager?</Text>

            <TouchableOpacity onPress={CreateLeague} style={{ marginLeft: 10 }}>
              <Text style={styles.link}>Create League</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>

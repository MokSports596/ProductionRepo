...
<Image style = {{position: "absolute", height: 0.05*windowHeight, width: 0.1*windowWidth, left: 0.3*windowWidth, top: 0.06*windowHeight}} resizeMode={'cover'} source = {require('../assets/Homepage/flag.png')}/>
...
<Image style = {{position: "absolute", height: 0.055*windowHeight, width: windowWidth, top: 0.15*windowHeight, alignSelf: "center", zIndex: "99"}} resizeMode={'cover'} source = {require('../assets/swoop.png')}/>
    ...
    <View style = {styles.BodyContainer}>
      ...
      <Player isSelf = {true} name = "BigAssTruck" season = "4" wk = "+6" skins = "1" LOKs = "3" ranking = "#3"/>
...
width:0.8*windowWidth
    ...
    <View style = {{minHeight: 50, borderRadius: 20, borderColor: "border: 1px solid rgba(229, 229, 229, 1)", borderWidth: 1, width: 0.9*windowWidth, marginTop: -0.02*windowHeight, display: "flex", alignItems: "center", justifyContent: "center"}}>
    <Image style = {{position: "absolute", height: 0.06*windowHeight, width: 0.1*windowWidth, alignSelf: "center", top: -0.035*windowHeight}} resizeMode={'cover'} source = {require('../assets/Homepage/lock.png')}/>
    <Text style = {{width: 0.9*windowWidth, marginBottom: 0.005*windowHeight, alignSelf: "center", textAlign: "center", fontFamily: "Poppins",fontSize: "19",fontWeight: "500", marginTop: 0.02*windowHeight, color: "background: rgba(172, 101, 214, 1);"}}>49:00:00</Text>
    ...
    <Team team = "49ers" LOKs = {3}></Team>
      ...
      <View style = {styles.infoContainer}>
            ...
            <View style = {styles.containerHeader}>
                ...
                <TouchableOpacity  style = {{position: "absolute", height: 0.03*windowHeight, width: 0.05*windowWidth, alignSelf: "flex-start", left: 0.05*windowWidth}} onPress = {decrementWeek}>
                <Image style = {{position: "absolute", height: 0.03*windowHeight, width: 0.05*windowWidth, alignSelf: "flex-start"}}resizeMode={'cover'} source = {require('../assets/Homepage/leftarrowWhite.png')}/>
                </TouchableOpacity>
                <TouchableOpacity style = {{position: "absolute", height: 0.03*windowHeight, width: 0.05*windowWidth, alignSelf: "flex-end", right: 0.05*windowWidth}} onPress = {incrementWeek}>
                <Image style = {{position: "absolute", height: 0.03*windowHeight, width: 0.05*windowWidth, alignSelf: "flex-end"}}resizeMode={'cover'} source = {require('../assets/Homepage/rightarrowWhite.png')}/>
                </TouchableOpacity>
                </View>
            ...
            <FlatList
        data={gameData}
        renderItem={({item}) => <Game team1={item.homeTeam}  team2 = {item.awayTeam}/>}
      ...
      />
            ...
            <Text style = {{fontSize: 20, color: "white", fontWeight: "bold", padding: 2, paddingRight: 5, paddingLeft: 5, overflow: "hidden", borderRadius:"10px", alignSelf: "flex-end", marginRight: "10%"}}>6 Points</Text>
            </View>

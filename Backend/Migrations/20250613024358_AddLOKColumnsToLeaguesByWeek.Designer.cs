...
namespace MokSportsApp.Migrations
{
    ...
    [Migration("20250613024358_AddLOKColumnsToLeaguesByWeek")]
    partial class AddLOKColumnsToLeaguesByWeek
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MokSportsApp.Models.LeaguesByWeek", b =>
                {
                    ...
                    b.Property<int?>("Franchise1LOKedTeamId")
                        .HasColumnType("int");

                    b.Property<int>("Franchise1SeasonPoints")
                        .HasColumnType("int");

                    b.Property<bool>("Franchise1UsedLoad")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("Franchise2LOKedTeamId")
                        .HasColumnType("int");

                    b.Property<int>("Franchise2SeasonPoints")
                        .HasColumnType("int");

                    b.Property<bool>("Franchise2UsedLoad")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("Franchise3LOKedTeamId")
                        .HasColumnType("int");

                    b.Property<int>("Franchise3SeasonPoints")
                        .HasColumnType("int");

                    b.Property<bool>("Franchise3UsedLoad")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("Franchise4LOKedTeamId")
                        .HasColumnType("int");

                    b.Property<int>("Franchise4SeasonPoints")
                        .HasColumnType("int");

                    b.Property<bool>("Franchise4UsedLoad")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("Franchise5LOKedTeamId")
                        .HasColumnType("int");

                    b.Property<int>("Franchise5SeasonPoints")
                        .HasColumnType("int");

                    b.Property<bool>("Franchise5UsedLoad")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("Franchise1LOKedTeamId");

                    b.HasIndex("Franchise2Id");

                    b.HasIndex("Franchise2LOKedTeamId");

                    b.HasIndex("Franchise3Id");

                    b.HasIndex("Franchise3LOKedTeamId");

                    b.HasIndex("Franchise4Id");

                    b.HasIndex("Franchise4LOKedTeamId");

                    b.HasIndex("Franchise5Id");

                    b.HasIndex("Franchise5LOKedTeamId");
            ...
            modelBuilder.Entity("MokSportsApp.Models.LeaguesByWeek", b =>
                {
                    ...
                    b.HasOne("MokSportsApp.Models.Team", "Franchise1LOKedTeam")
                        .WithMany()
                        .HasForeignKey("Franchise1LOKedTeamId");
                    ...
                    b.HasOne("MokSportsApp.Models.Team", "Franchise2LOKedTeam")
                        .WithMany()
                        .HasForeignKey("Franchise2LOKedTeamId");
                    ...
                    b.HasOne("MokSportsApp.Models.Team", "Franchise3LOKedTeam")
                        .WithMany()
                        .HasForeignKey("Franchise3LOKedTeamId");
                    ...
                    b.HasOne("MokSportsApp.Models.Team", "Franchise4LOKedTeam")
                        .WithMany()
                        .HasForeignKey("Franchise4LOKedTeamId");
                    ...
                    b.HasOne("MokSportsApp.Models.Team", "Franchise5LOKedTeam")
                        .WithMany()
                        .HasForeignKey("Franchise5LOKedTeamId");
                    ...
                    b.Navigation("Franchise1LOKedTeam");

                    b.Navigation("Franchise2");

                    b.Navigation("Franchise2LOKedTeam");

                    b.Navigation("Franchise3");

                    b.Navigation("Franchise3LOKedTeam");

                    b.Navigation("Franchise4");

                    b.Navigation("Franchise4LOKedTeam");

                    b.Navigation("Franchise5");

                    b.Navigation("Franchise5LOKedTeam");
